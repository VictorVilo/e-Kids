 ...
 */
public class ImageDetection extends Activity implements CvCameraViewListener2 {
    /**
     * class name for debugging with logcat
     */
    private static final String TAG = ImageDetection.class.getName();
    /**
     * the camera view
     */
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        for (MatOfPoint cnt : contours) {
            ...
            if (java.lang.Math.abs(contourArea) < 100
            ...
            // circle detection
                ...
                if (java.lang.Math.abs(
                        ...
                        java.lang.Math.abs(
                                1 - (
                                        contourArea / (java.lang.Math.PI * radius * radius)
                                )
                        ) <= 0.2
                ) {
                    if (!DISPLAY_IMAGES) {
