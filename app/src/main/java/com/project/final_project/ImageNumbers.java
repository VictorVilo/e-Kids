...
public class ImageNumbers extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_numbers);
    ...
    public void onInit(int status) {
        ...
        if (status == TextToSpeech.SUCCESS) {
            ...
            if (result == TextToSpeech.LANG_MISSING_DATA
                ...
                Toast.makeText(ImageNumbers.this, "This Language is not supported", Toast.LENGTH_SHORT).show();
            } else {
